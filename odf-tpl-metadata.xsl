<!-- $Id$ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.tei-c.org/ns/1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" exclude-result-prefixes="t" version="2.0">
  ...
  <xsl:template name="metadata_footer">
      <xsl:if test="string(//t:text/t:body/t:div[@type='bibliography' and @subtype='illustrations']/t:p) or                     string(//t:text/t:body/t:div[@type='commentary' and @subtype='general']/t:p)">
        <text:p text:style-name="Sammelbuch-Fußstrich"/>
      </xsl:if>
    	<xsl:if test="string(//t:text/t:body/t:div[@type='bibliography' and @subtype='illustrations']/t:p)     and not(//t:text/t:body/t:div[@type='bibliography' and @subtype='illustrations']/t:p = 'keine')">
  ...
  <xsl:template name="metadata_edition">
    ...
    <xsl:choose>
        <xsl:when test="string(bliblio/t:title[@level='m' and @type='main'])                      or string($biblio/t:title[@level='m' and @type='short'])">
